...
from me.core.views import springsteen_results, springsteen_firehose, \
                            home_list, springsteen_category, contact_form, \
                            proxy_search
from robots.views import rules_list
from me.core.feeds import AllEntries, ByTag
...
handler500 = "me.core.views.server_error"
...
urlpatterns += patterns('',
    ...
    url(r'^oops/$', 'me.core.views.oops', name='raise_exception'),
    url(r'^quotes/$', 'me.core.views.quote_list', name='quote_list'),
    url(r'^quotes/(?P<slug>[-\w]+)/$', 'me.core.views.quote_detail', name='quote_detail'),
    ...
    url(r'^tags/(?P<slug>[-\w]+)/$', 'me.core.views.tag_detail',
